...
def game():
    ...
    words = ['Deodat thinks that class 31 LCSP is the best class he has ever taught.', 'The plots failed because of some trusted friends of the king.', 'After the death of the king, everyone wanted to be a king.', 
